...
define([
  ...
  var getSprintID = function getRapidBoardID(rapidBoardID, cb){
    cb(sprintID);
  }
  ...
  return function sprint(rapidBoardID, sprintID) {
    getRapidBoardID(rapidBoardID, function(rapidBoardID) {
      getSprintID(sprintID, function(sprintID) {
      });
    });
  }
          ...
          that.ask('Issue title: ', function (issueTitle) {
            ...
            that.ask('Issue description: ', function (issueDescription) {
              ...
              that.askIssuePriorities(function (issuePriority) {
                ...
                that.ask('Issue assignee: ', function (assignee) {
